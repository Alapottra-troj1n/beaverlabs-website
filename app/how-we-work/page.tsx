        ...
        <div className="min-h-screen bg-white overflow-x-hidden">
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-10 xl:px-0 pt-36 pb-20 text-center">
                ...
                >
                    ...
                    <p className={`text-zinc-500 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed ${manrope.className}`}>
                            ...
                            <div className={`flex flex-col ${isEven ? 'lg:flex-row-reverse' : 'lg:flex-row'} items-center gap-16 lg:gap-24`}>
                                ...
                                >
                                    <div className="flex items-center gap-4 mb-6">
                                        ...
                                        <div className="h-0.5 w-12 bg-[#7370FF]/50" />
                                    </div>
                                    <h2 className={`${manrope.className} text-3xl md:text-4xl lg:text-6xl font-bold text-zinc-900 mb-8 tracking-tight leading-[1.1]`}>
                                        {step.title}
                                    </h2>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                                        {step.details.map((detail, i) => (
                                            <div key={i} className="flex items-center gap-4 text-zinc-600">
                                                ...
                                                <span className={`text-base font-bold ${manrope.className}`}>{detail}</span>
                                            </div>
                                        ))}
                                    </div>
                                </motion.div>
                                ...
                                <motion.div
                                    ...
                                    viewport={{ once: true, amount: 0.3 }}
                                >
                                    <div className={`relative aspect-square md:aspect-video lg:aspect-square rounded-[3rem] overflow-hidden border border-zinc-200 bg-linear-to-br ${step.gradient} group shadow-2xl shadow-[#7370FF]/5`}>
                                        <div className="relative w-full h-full group-hover:scale-110 transition-transform duration-1000 ease-out">
                                            ...
                                            />
                                            {/* Subtle overlay */}
                                            <div className="absolute inset-0 bg-linear-to-b from-transparent to-black/20 group-hover:to-black/0 transition-all duration-700" />
                                        </div>
                                        ...
                                        <div className="absolute bottom-8 left-8 right-8 p-6 rounded-2xl bg-white/90 backdrop-blur-xl border border-white/20 opacity-0 group-hover:opacity-100 transition-all duration-700 translate-y-6 group-hover:translate-y-0 shadow-2xl">
                                            <p className={`${manrope.className} text-zinc-900 text-xl font-bold mb-1`}>{step.title} Phase</p>
                                            <p className={`text-zinc-500 text-sm ${manrope.className}`}>Precision excellence at every milestone.</p>
                                        </div>
                                    </div>
                                </motion.div>
                            </div>
            ...
            <section className="max-w-7xl mx-auto px-6 md:px-10 xl:px-0 py-28">
                ...
                >
                    ...
                    <h2 className={`${manrope.className} text-4xl md:text-5xl lg:text-7xl font-bold text-zinc-900 tracking-tight mb-8 relative z-10 leading-[1.1]`}>
                        Have a Vision? <br /> Let&apos;s Build it Together.
                    </h2>
                    <p className={`text-zinc-500 text-lg md:text-xl lg:text-2xl max-w-2xl mx-auto mb-14 relative z-10 ${manrope.className}`}>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-8 relative z-10">
                        <a
                            href="tel:+09433443"
                            className="w-full sm:w-auto px-12 py-5 rounded-full bg-linear-to-r from-[#7370FF] to-[#9C99FF] text-white font-bold text-xl hover:scale-105 active:scale-95 transition-all duration-300 shadow-[0_20px_40px_rgba(115,112,255,0.4)]"
                        >
